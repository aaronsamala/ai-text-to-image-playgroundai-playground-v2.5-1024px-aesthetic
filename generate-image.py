...
# prompts = ["a comic book style illustration of a superhero in a dynamic action pose, with vibrant colors and bold linework.","a comic book style illustration of 5 spiderman characters in a circle pointing at eachother with the words 'MalPDF cross-references' in the middle"]
...
prompts = [
    ...
    "A serene mountain lake at sunrise, with reflections of the surrounding peaks in the still water. the silhouette of the mountains resembles a sleeping dragon.",
...
for prompt in prompts:
    ...
    filename = datetime.now().strftime("%Y-%m-%d-%H-%M-%S") + "-ChatGPT-Prompts-with-Karras" + ".jpg"
